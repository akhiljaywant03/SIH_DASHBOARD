...
#define WIFI_SSID "only" // SSID of your WIFI
#define WIFI_PASSWD "77777777" //your wifi password

#define CLIENT_ID "ESP"// thing unique ID, this id should be unique among all things associated with your AWS account.
#define MQTT_TOPIC "$aws/things/ESP_RFID/shadow/update" //topic for the MQTT data
#define AWS_HOST "avawwsnryj61m-ats.iot.ap-south-1.amazonaws.com" // your host for uploading data to AWS,
...
/*
  ...
  if(temp == NAN || humidity == NAN){ // NAN means no available data
    ...
    temp_humidity += " %";
*/  
    String temp_humidity = "Hello from ESP";
